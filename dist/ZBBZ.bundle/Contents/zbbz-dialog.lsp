...
(defun zbbz-dialog-locale-code (/ locale_code)
  (setq locale_code (getvar "LOCALE"))
  (if locale_code
    (strcase locale_code)
    ""))

(defun zbbz-dialog-language-key (/ locale_code prefix)
  (setq locale_code (zbbz-dialog-locale-code))
  (if (>= (strlen locale_code) 2)
    (setq prefix (substr locale_code 1 2))
    (setq prefix ""))
  (cond
    ((or (= prefix "ZH") (= prefix "CH")) "zh")
    ((= prefix "FR") "fr")
    ((= prefix "DE") "de")
    ((= prefix "IT") "it")
    ((= prefix "JA") "ja")
