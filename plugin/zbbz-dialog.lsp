...
(defun zbbz-dialog-populate ()
  ...
  (zbbz-dialog-debug-prompt (strcat "coord_current tile=" (get_tile "coord_current")))
  (zbbz-dialog-debug-prompt (strcat "coord_world tile=" (get_tile "coord_world")))
  (zbbz-dialog-debug-prompt (strcat "coord_custom tile=" (get_tile "coord_custom")))
  (zbbz-dialog-debug-prompt (strcat "prefix_xy tile=" (get_tile "prefix_xy")))
  (zbbz-dialog-debug-prompt (strcat "prefix_ab tile=" (get_tile "prefix_ab")))
  (zbbz-dialog-debug-prompt (strcat "prefix_ne tile=" (get_tile "prefix_ne")))
  (zbbz-dialog-debug-prompt (strcat "prefix_none tile=" (get_tile "prefix_none")))
...
(defun zbbz-dialog-save-prefix-mode ()
  (cond
    ...
    ((equal (get_tile "prefix_ne") "1") (zbbz-state-put 'prefix_mode 'ne))
    ((equal (get_tile "prefix_none") "1") (zbbz-state-put 'prefix_mode 'none))
    (T (zbbz-state-put 'prefix_mode 'xy))))

(defun zbbz-dialog-save-coord-mode ()
  (cond
    ((equal (get_tile "coord_world") "1") (zbbz-state-put 'coord_mode 'world))
    ((equal (get_tile "coord_custom") "1") (zbbz-state-put 'coord_mode 'custom))
...
(defun zbbz-dialog-bind-actions ()
  (action_tile "coord_current" "(if (not *zbbz-dialog-initializing*) (progn (zbbz-dialog-save-coord-mode) (zbbz-dialog-update-custom-input-state)))")
  (action_tile "coord_world" "(if (not *zbbz-dialog-initializing*) (progn (zbbz-dialog-save-coord-mode) (zbbz-dialog-update-custom-input-state)))")
  (action_tile "coord_custom" "(if (not *zbbz-dialog-initializing*) (progn (zbbz-dialog-save-coord-mode) (zbbz-dialog-update-custom-input-state)))")
  ...
  (action_tile "prefix_none" "(if (not *zbbz-dialog-initializing*) (progn (zbbz-dialog-save-prefix-mode) (zbbz-dialog-sync-preview)))")
